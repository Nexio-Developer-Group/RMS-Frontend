...
const CookiePolicy = () => {
    return (
        ...
        >
            <section>
                <p>
                    This is the Cookie Policy for RestoPOS, accessible from restopos.com.
                </p>
                <p>
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>
                        <strong>Processing related cookies:</strong> This site offers e-commerce or payment facilities and some cookies are essential to ensure that your order is remembered between pages so that we can process it properly.
                    </li>
                </ul>
            </section>
