...
import { PiBellDuotone, PiArrowClockwiseBold, PiSunDuotone, PiMoonDuotone } from 'react-icons/pi'
                        ...
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-8 shrink-0 bg-[#EA580C] rounded-lg flex items-center justify-center p-1.5 shadow-sm">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full text-white">
                                    <path d="M7 17L17 7M10 17L17 10" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </div>
                            <div className="flex flex-col">
                                <span className="text-[10px] text-slate-500 font-semibold leading-none mb-0.5">Somi</span>
                                <span className="text-sm font-bold text-slate-900 dark:text-white leading-none">Restaurant</span>
                            </div>
                        </div>
                ...
                headerEnd={
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <Select defaultValue="ahmedabad-1">
                            ...
                            <SelectContent>
                                <SelectItem value="ahmedabad-1">Ahmedabad - Devendra Nagar</SelectItem>
                                <SelectItem value="ahmedabad-2">Ahmedabad - Prahlad Nagar</SelectItem>
                                <SelectItem value="ahmedabad-3">Ahmedabad - Satellite Area</SelectItem>
                                <SelectItem value="ahmedabad-4">Ahmedabad - Bodakdev</SelectItem>
                                <SelectItem value="ahmedabad-5">Ahmedabad - Vastrapur</SelectItem>
                            </SelectContent>
                        </Select>
                        ...
                        <div className="flex items-center gap-1.5 sm:gap-2 ml-1">
                            <Button
                                ...
                                icon={isDark ? <PiMoonDuotone className="text-xl" /> : <PiSunDuotone className="text-xl" />}
                            />
                            <Button
                                size="sm"
                                shape="circle"
                                ...
                                icon={<PiArrowClockwiseBold className="text-lg text-slate-600 dark:text-slate-400" />}
                            />
                            <Button
                                size="sm"
                                shape="circle"
                                variant="plain"
                                className="w-9 h-9 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800"
                                icon={<PiBellDuotone className="text-xl text-slate-600 dark:text-slate-400" />}
                            />
                        </div>
